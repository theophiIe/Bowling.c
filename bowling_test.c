...
void AfficherMenu(){
	while (EcranPrincipal){
		if (!initEcranPrincipal){
			...
			T1.x = 175;		T1.y = 29*hauteur_texte(Titre,20);
			T2.x = 180;		T2.y = 28.9*hauteur_texte(Titre,20);
			...
			if (!PartieEnCours){
				...
				T1.x = 215;		T1.y = 22.5*hauteur_texte(Titre,20);
				T2.x = 217.5;	T2.y = 22.45*hauteur_texte(Titre,20);
...
void AfficherScoreFin(){
	while (EcranScore){
		if (!initEcranScore){
			...
			if (!Multijoueur){
				T1.x = 420;		T1.y = 29*hauteur_texte(Titre,20);
				T2.x = 425;		T2.y = 28.9*hauteur_texte(Titre,20);
				...
				T1.x = 415;		T1.y = 22.5*hauteur_texte(Titre,20);
				T2.x = 417.5;	T2.y = 22.45*hauteur_texte(Titre,20);
				aff_pol(MenuTitre2,45,T2,black);
				aff_pol(MenuTitre2,45,T1,white);
				...
				T1.x = 190;		T1.y = 29*hauteur_texte(Titre,20);
				T2.x = 195;		T2.y = 28.9*hauteur_texte(Titre,20);
				aff_int(Score,150,T2,black);
				aff_int(Score,150,T1,white);

				T2.x = 155;		T2.y = 24.3*hauteur_texte(Titre,20);
				if (CouleurBoule == 0){
					...
					T1.x = 500;		T1.y = 29*hauteur_texte(Titre,20);
					T2.x = 505;		T2.y = 28.9*hauteur_texte(Titre,20);
					aff_pol(SeparationScore,150,T2,black);
					aff_pol(SeparationScore,150,T1,white);

					T1.x = 610;		T1.y = 29*hauteur_texte(Titre,20);
					T2.x = 615;		T2.y = 28.9*hauteur_texte(Titre,20);
					aff_int(ScoreJoueur2,150,T2,black);
					aff_int(ScoreJoueur2,150,T1,white);
					T2.x = 575;		T2.y = 24.3*hauteur_texte(Titre,20);
					if (CouleurBouleJoueur2 == 0){
